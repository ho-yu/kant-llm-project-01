...
| 입력 범위 | 상품 맥락을 프롬프트에 넣지 않고 물었다 — 상세페이지 기반 응답은 평가 범위 밖 |
| 한국어 성능 | **중요** |
| 응답 속도 | **중요** |
| 데이터 보안 | 중요하지 않음 → STEP 7 Local–Cloud 판단 근거로 재사용 |
| GPU | RTX 5060 Laptop · VRAM 8,151 MiB (노트북 1대) |

원문: [docs/steps/step01.md](docs/steps/step01.md)

## 2. 선정 기준

**선정 목표** — 일반 쇼핑몰 고객의 문의와 셀러의 업무 질문에 한국어로
정확하고 신속하게 답할 수 있는 로컬 모델을 고른다.

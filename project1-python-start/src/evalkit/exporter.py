...
def model_comparison_table() -> str:
    ...
    rows: list[tuple[str, object]] = [
        ...
        ("Architecture", lambda l: entries[l].get("architecture") or "(미확인)"),
        ("Language (문서상)", lambda l: entries[l].get("language_declared") or "(미확인)"),
        ("Benchmark (문서상)", lambda l: entries[l].get("benchmark_declared") or "(미확인)"),
